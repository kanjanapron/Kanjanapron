<?php
    ...
    include_once("c.php"); // ไฟล์เชื่อมต่อฐานข้อมูลที่คุณมีจริง
?>
<!doctype html>
<html lang="th">
<head>
...
<nav class="navbar navbar-expand-lg navbar-dark shadow-sm mb-4">
    <div class="container">
        <a class="navbar-brand fw-bold" href="index2.php">Kanjanapron Admin</a>
        ...
        <div class="col-md-3 mb-4">
            <div class="card p-3">
                ...
                <div class="list-group list-group-flush">
                    <a href="products.php" class="list-group-item list-group-item-action border-0 sidebar-link">📦 จัดการสินค้า</a>
                    <a href="orders.php" class="list-group-item list-group-item-action border-0 sidebar-link active" style="background-color: #f8bbd0; border-radius: 10px;">📝 จัดการออเดอร์</a>
                    <a href="costomers.php" class="list-group-item list-group-item-action border-0 sidebar-link">👥 จัดการลูกค้า</a>
                    <hr>
                    <a href="logout.php" class="list-group-item list-group-item-action border-0 text-danger fw-bold">🚪 ออกจากระบบ</a>
                </div>
            </div>
        </div>
