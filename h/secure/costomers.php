<?php
    ...
    include_once("../g/c.php"); // ไฟล์เชื่อมต่อฐานข้อมูลของคุณ
?>
<!doctype html>
<html lang="th">
<head>
...
<nav class="navbar navbar-expand-lg navbar-dark shadow-sm mb-4">
    <div class="container">
        <a class="navbar-brand fw-bold" href="../g/index2.php"><i class="bi bi-person-badge-fill me-2"></i>Admin Panel</a>
    ...
    <div class="row mb-4">
        <div class="col-md-8">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="../g/index2.php" class="text-pink">หน้าหลัก</a></li>
        ...
        <div class="col-lg-3 mb-4">
            <div class="card p-3">
                <div class="list-group list-group-flush">
                    <a href="../g/products.php" class="list-group-item list-group-item-action border-0 nav-link-custom"><i class="bi bi-box-seam me-2"></i> จัดการสินค้า</a>
                    <a href="../g/orders.php" class="list-group-item list-group-item-action border-0 nav-link-custom"><i class="bi bi-cart-check me-2"></i> จัดการออเดอร์</a>
                    <a href="../g/costomers.php" class="list-group-item list-group-item-action border-0 nav-link-custom active" style="background-color: #fce4ec; border-radius: 10px; color: #d81b60;"><i class="bi bi-people-fill me-2"></i> จัดการลูกค้า</a>
                    <hr>
                    <a href="../g/logout.php" class="list-group-item list-group-item-action border-0 text-danger fw-bold" onclick="return confirm('ยืนยันออกจากระบบ?')"><i class="bi bi-box-arrow-right me-2"></i> ออกจากระบบ</a>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="../g/edit_customer.php?id=<?php echo $row['c_id']; ?>" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil-square"></i></a>
                                        <a href="../g/del_customer.php?id=<?php echo $row['c_id']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('ลบข้อมูลลูกค้าท่านนี้หรือไม่?')"><i class="bi bi-trash-fill"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php 
