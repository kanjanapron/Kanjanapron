...
<nav class="navbar navbar-expand-lg navbar-dark mb-5">
    <div class="container">
        ...
        <div class="ms-auto d-flex align-items-center">
            ...
            <a href="../g/logout.php" class="btn btn-sm logout-btn text-white" onclick="return confirm('คุณต้องการออกจากระบบใช่หรือไม่?')">
...
<div class="container">
    ...
    <div class="row g-4 justify-content-center">
        <div class="col-6 col-lg-3">
            <a href="../g/products.php" class="card card-menu h-100 p-4 text-center">
        ...
        <div class="col-6 col-lg-3">
            <a href="../g/orders.php" class="card card-menu h-100 p-4 text-center">
        ...
        <div class="col-6 col-lg-3">
            <a href="../g/costomers.php" class="card card-menu h-100 p-4 text-center">
